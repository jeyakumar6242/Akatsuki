...
public class Config {
	...
	public enum EndPointEnum {
		CUST_DETAILS, DEMAT_HOLDING, FUND, HIST_CHART, MARGIN, ORDER, PORTFOLIO_HOLDING, PORTFOLIO_POSITION, QUOTE,
		TRADE, OPT_CHAIN, SQUARE_OFF, PREVIEW_ORDER, LIMIT_CALCULATOR, MARGIN_CALCULATOR
	}

	public enum UrlEnum {

		API_URL, BREEZE_NEW_URL, LIVE_FEEDS_URL, LIVE_STREAM_URL, LIVE_OHLC_STREAM_URL, SECURITY_MASTER_URL,
		STOCK_SCRIPT_CSV_URL
	}
	...
	public enum ResponseEnum {
		...
		BLANK_PRODUCT_TYPE_HIST_V2, BLANK_ORDER_TYPE, BLANK_QUANTITY, BLANK_VALIDITY, BLANK_ORDER_ID, BLANK_FROM_DATE,
		BLANK_TO_DATE, BLANK_TRANSACTION_TYPE, BLANK_AMOUNT, BLANK_SEGMENT, BLANK_INTERVAL, BLANK_STRIKE_PRICE,
		BLANK_EXPIRY_DATE, BLANK_RIGHT_STRIKE_PRICE, BLANK_RIGHT_EXPIRY_DATE, BLANK_EXPIRY_DATE_STRIKE_PRICE,
		BLANK_RIGHT_TYPE, BLANK_STOP_LOSS_TRIGGER, BLANK_OPTION_TYPE,

		// Validation Errors
		EXCHANGE_CODE_ERROR, EXCHANGE_CODE_HIST_V2_ERROR, PRODUCT_TYPE_ERROR, PRODUCT_TYPE_ERROR_NFO,
		PRODUCT_TYPE_ERROR_HIST_V2, ACTION_TYPE_ERROR, ORDER_TYPE_ERROR, VALIDITY_TYPE_ERROR, RIGHT_TYPE_ERROR,
		TRANSACTION_TYPE_ERROR, ZERO_AMOUNT_ERROR, INTERVAL_TYPE_ERROR, INTERVAL_TYPE_ERROR_HIST_V2, API_SESSION_ERROR,
		OPT_CHAIN_EXCH_CODE_ERROR, NFO_FIELDS_MISSING_ERROR,
	...
	public enum ExceptionEnum {
		...
		// Subscribe Exception
		QUOTE_DEPTH_EXCEPTION, EXCHANGE_CODE_EXCEPTION, STOCK_CODE_EXCEPTION, EXPIRY_DATE_EXCEPTION,
		PRODUCT_TYPE_EXCEPTION, STRIKE_PRICE_EXCEPTION, RIGHT_EXCEPTION, STOCK_INVALID_EXCEPTION,
		WRONG_EXCHANGE_CODE_EXCEPTION, STOCK_NOT_EXIST_EXCEPTION, ISEC_NSE_STOCK_MAP_EXCEPTION,
		STREAM_OHLC_INTERVAL_ERROR,
	...
	public enum ListEnum {
		INTERVAL_TYPES, INTERVAL_TYPES_HIST_V2, INTERVAL_TYPES_STREAM_OHLC, PRODUCT_TYPES, PRODUCT_TYPES_HIST,
		PRODUCT_TYPES_HIST_V2, RIGHT_TYPES, ACTION_TYPES, ORDER_TYPES, VALIDITY_TYPES, TRANSACTION_TYPES,
		EXCHANGE_CODES_HIST, EXCHANGE_CODES_HIST_V2
	}
		...
		responseMessage = new EnumMap<ResponseEnum, String>(ResponseEnum.class) {
			{
				...
				put(ResponseEnum.BLANK_PRODUCT_TYPE_HIST_V2,
						"Product-type cannot be empty for Exchange-Code 'nfo','ndx' or 'mcx'");
				...
				put(ResponseEnum.EXCHANGE_CODE_HIST_V2_ERROR,
						"Exchange-Code should be either 'nse', 'bse' ,'nfo', 'ndx' or 'mcx'");
				put(ResponseEnum.PRODUCT_TYPE_ERROR,
						"Product should be either 'futures', 'options', 'futureplus', 'optionplus', 'cash', 'eatm', or 'margin'");
				put(ResponseEnum.PRODUCT_TYPE_ERROR_NFO,
						"Product-type should be either 'futures', 'options', 'futureplus', or 'optionplus' for Exchange-Code 'NFO'");
				put(ResponseEnum.PRODUCT_TYPE_ERROR_HIST_V2,
						"Product-type should be either 'futures', 'options' for Exchange-Code 'NFO','NDX' or 'MCX'");
				...
				put(ResponseEnum.INTERVAL_TYPE_ERROR,
						"Interval should be either '1minute', '5minute', '30minute', or '1day'");
				put(ResponseEnum.INTERVAL_TYPE_ERROR_HIST_V2,
						"Interval should be either '1second','1minute', '5minute', '30minute', or '1day'");
				...
				put(ResponseEnum.NFO_FIELDS_MISSING_ERROR,
						"Atleast two inputs are required out of Expiry-Date, Right & Strike-Price. All three cannot be empty'.");
				...
				put(ResponseEnum.ORDER_REFRESH_DISCONNECTED,
						"socket server for order streaming has been disconnected.");
		...
		exceptionMessage = new EnumMap<ExceptionEnum, String>(ExceptionEnum.class) {
			{
				...
				put(ExceptionEnum.PRODUCT_TYPE_EXCEPTION,
				...
				put(ExceptionEnum.WRONG_EXCHANGE_CODE_EXCEPTION,
						"Stock-Token cannot be found due to wrong exchange-code.");
				put(ExceptionEnum.STOCK_NOT_EXIST_EXCEPTION,
						"Stock-Data does not exist in exchange-code %s for Stock-Token %s.");
				put(ExceptionEnum.ISEC_NSE_STOCK_MAP_EXCEPTION, "Result Not Found");
				put(ExceptionEnum.STREAM_OHLC_INTERVAL_ERROR,
						"Interval should be either '1second','1minute', '5minute', '30minute'");

				// API Call Exception
				put(ExceptionEnum.API_REQUEST_EXCEPTION, "Error while trying to make request %s %s");
				put(ExceptionEnum.INVALID_REQUEST_EXCEPTION,
						"Invalid Request Method - Must be GET, POST, PUT or DELETE");
			}
		};
	}
		...
		typeLists = new EnumMap<ListEnum, String[]>(ListEnum.class) {
			{
				...
				put(ListEnum.INTERVAL_TYPES_HIST_V2,
						new String[] { "1second", "1minute", "5minute", "30minute", "1day" });
				put(ListEnum.INTERVAL_TYPES_STREAM_OHLC, new String[] { "1second", "1minute", "5minute", "30minute" });
				put(ListEnum.PRODUCT_TYPES,
						new String[] { "futures", "options", "futureplus", "optionplus", "cash", "eatm", "margin" });
